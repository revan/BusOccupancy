%\documentclass[letterpaper,abstract,titlepage=false,twocolumn]{scrreprt}
...
the periodic nature of class schedules, students at Rutgers tend to move between campuses in certain known time intervals during the day.
