...
\bigfig{bus-grid-fixed}{First and Last times seen for each MAC address observed while on the bus route}{fig:busgrid}
...
\bigfig{bus-segments-wide}{Predicted number of passengers using the Segments approximation}{fig:segments}
...
\bigfig{bus-vectors-wide}{Predicted number of passengers using the Vector approximation}{fig:vector}
