...
The reason for this update is to deter tracking by companies for the purpose of targeted advertisements and to provide higher security for consumers ~\cite{ios8_privacy}.
Apple iPhones make up over 40\% of the smartphones owned in the US, and so this update would greatly impact the effectiveness of our program ~\cite{iphone_ownership}.
