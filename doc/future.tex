...
\bigfig{lecture-grid}{First and Last times seen for each MAC address during the class period}{fig:probgrid}

\bigfig{packethist-sorted}{Number of packets involving each MAC address present during the entirety of the class period}{fig:probhist}
